...
for i, batch in enumerate(val_data):
    ...
    for j in range(batch_size):
        ...
        before_tvm_inference = time.time()
        # tvm_output = tvm_model(tvm.nd.array(data[j].reshape((1, 3, 224, 224)).astype(dtype)))
        ...
        if target[j] in top5:
            top5_acc += 1
    print("batch tvm_inference", sum_tvm_inference/validation_samples_cnt)
    print("batch tvm_accuracy top1_acc", top1_acc/validation_samples_cnt)
    print("batch tvm_accuracy top5_acc", top5_acc/validation_samples_cnt)
...
print("tvm_inference", sum_tvm_inference/validation_samples_cnt)
print("tvm_accuracy top1_acc", top1_acc/validation_samples_cnt)
print("tvm_accuracy top5_acc", top5_acc/validation_samples_cnt)
